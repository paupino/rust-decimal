...
mod maths {
    ...
    fn test_powd() {
        let test_cases = &[
            ...
            // ~= 0.8408964152537145
            ("0.5", "0.25", "0.8410938963634267005719877122"),
    ...
    fn test_exp_with_tolerance() {
        let test_cases = &[
            ...
            // e^11.7578+ starts to overflow
            ("123", "0.0002", ""),
            // e^-8 ~= 0.00033546262790251183882138912578086
            ("-8", "0.0002", "0.0003354626377168530220952633"),
            // e^-9 ~= 0.00012340980408667954949763669073003
            ("-9", "0.0002", "0.0001234098417553083895710102"),
            // e^-11.7578 ~= 0.0000078280274640416958435053296970758
            ("-11.7578", "0.0002", "0.0000078283379821375683874438"),
            // e^-11.7578+ starts to underflow
            ("-11.7579", "0.0002", ""),
        ];
