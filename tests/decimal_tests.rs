    ...
    fn test_norm_cdf() {
        let test_cases = &[
            (
                ...
                Decimal::from_str("0.3445781286821245037094401705").unwrap(),
            ),
            (
                Decimal::from_str("-0.1").unwrap(),
                Decimal::from_str("0.4601722899186706579921922695").unwrap(),
            ),
            (
                Decimal::from_str("0.1").unwrap(),
                Decimal::from_str("0.5398277100813293420078077305").unwrap(),
            ),
            (
                Decimal::from_str("0.4").unwrap(),
                Decimal::from_str("0.6554218713178754962905598295").unwrap(),
            ),
            (
                Decimal::from_str("2.0").unwrap(),
