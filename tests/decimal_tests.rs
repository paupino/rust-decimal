...
fn round_sf_large_digits_does_not_overflow() {
    let n = Decimal::MAX;
    assert_eq!(n.round_sf(100), Some(n));
    assert_eq!(n.round_sf(u32::MAX), Some(n));
}
...
mod maths {
    ...
    fn test_powd() {
        let test_cases = &[
            ...
            (
                "0.0000000000000000000000000001",
                "0.1234567890123456789012345678",
                "0.0003533642785231574687918181",
            ),
    ...
    fn test_ln() {
        let test_cases = [
            ...
            (
                "0.0000000000000000000000000001",
                "-64.472382603833279152503760712",
            ),
            (
                "0.0000000000000000000000000007",
                "-62.526472454777965847398407968",
            ),
        ];
